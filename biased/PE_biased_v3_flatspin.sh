#!/bin/bash -l
#SBATCH --job-name=PE_biased_v3_flatspin
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SCRIPT="biased/PE_biased.py"

POP_OUTDIR="/scratch/gpfs/ANDREASB/fy6204/GW/Workspace/outputs/outdir_population_SEOBNR"
OUTDIR="/scratch/gpfs/ANDREASB/fy6204/GW/Workspace/biased/outputs/outdir_biased_v3_flatspin"
SPIN_MODE="flat"
