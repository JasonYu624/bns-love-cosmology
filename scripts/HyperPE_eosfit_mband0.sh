#!/bin/bash -l
#SBATCH --job-name=HyperPE_mband0_all
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
PE_OUTDIR="${RUNDIR}/outputs/outdir_population_run_mband0"
POSTERIOR_GLOB="${PE_OUTDIR}/*_reweighted_posterior_augmented.csv"

VT_GLOB="${RUNDIR}/outputs/outdir_selection_calib_eosfit/worker_*/detected_chunk*.npz"

OUTDIR="${RUNDIR}/outputs/outdir_hyperpe_run_mband0"
LABEL="hyperpe_mband0"
