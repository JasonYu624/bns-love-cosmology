#!/bin/bash -l
#SBATCH --job-name=PE_SEOBNR_qreflect
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SCRIPT="scripts/PE_SEOBNR_reweight_qreflect.py"

POP_OUTDIR="/scratch/gpfs/ANDREASB/fy6204/GW/Workspace/outputs/outdir_population_SEOBNR"
OUTDIR="/scratch/gpfs/ANDREASB/fy6204/GW/Workspace/outputs/outdir_population_run_SEOBNR_qreflect"
