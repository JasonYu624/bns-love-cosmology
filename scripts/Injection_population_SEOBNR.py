...
def parse_args():
    ...
    p.add_argument("--outdir", type=str, default="outputs/outdir_population_SEOBNR")
    p.add_argument("--label", type=str, default="bns_pop_inj_SEOBNR")
    p.add_argument("--target-n", type=int, default=100)
    p.add_argument("--base-seed", type=int, default=123)
    p.add_argument("--progress-every", type=int, default=50)
    p.add_argument("--signal-filename", type=str, default="bns_signal_SEOBNR_fd.npz")
    return p.parse_args()
