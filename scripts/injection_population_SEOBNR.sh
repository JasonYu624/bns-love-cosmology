#!/bin/bash -l
#SBATCH --job-name=population_SEOBNR
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SCRIPT="scripts/Injection_population_SEOBNR.py"
...
BASE_SEED=123
PROGRESS_EVERY=50
OUTDIR="outputs/outdir_population_SEOBNR"
LABEL="bns_pop_inj_SEOBNR"
SIGNAL_FILENAME="bns_signal_SEOBNR_fd.npz"
...
python "${SCRIPT}" \
  ...
  --signal-filename "${SIGNAL_FILENAME}"
