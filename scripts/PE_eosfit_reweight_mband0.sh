#!/bin/bash -l
#SBATCH --job-name=PE_eosfit_mband0_rw
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SCRIPT="scripts/PE_eosfit_reweight_mband0.py"

POP_OUTDIR="/scratch/gpfs/ANDREASB/fy6204/GW/Workspace/outputs/outdir_population_exactfd_mband0"
OUTDIR="/scratch/gpfs/ANDREASB/fy6204/GW/Workspace/outputs/outdir_population_run_mband0"
...
LABEL="bns_${EVENT_NAME}_eosfit_mband0"
