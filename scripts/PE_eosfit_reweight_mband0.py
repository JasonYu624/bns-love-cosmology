...
def get_args():
    ...
    parser.add_argument("--pop-outdir", default="outputs/outdir_population_exactfd_mband0")
    parser.add_argument("--event-index", type=int, default=1)
    parser.add_argument("--outdir", default="outputs/outdir_population_run_mband0")
...
if "PhenomXHMThresholdMband" in waveform_arguments_full:
    print(
        f"Using waveform argument PhenomXHMThresholdMband={waveform_arguments_full['PhenomXHMThresholdMband']}",
        flush=True,
    )
