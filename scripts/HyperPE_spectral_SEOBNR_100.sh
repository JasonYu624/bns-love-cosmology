#!/bin/bash -l
#SBATCH --job-name=HyperPE_Spectral_SEOBNR_100
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# VT_BASE="${RUNDIR}/outputs/outdir_selection_calib_eosfit"
VT_GLOB="${VT_BASE}/worker_*/detected_chunk*.npz"

OUTDIR="${RUNDIR}/outputs/outdir_spectral_siren_seobnr_100"
LABEL="spectral_siren_seobnr_100"
...
echo "================================================="
echo "Starting spectral-siren SEOBNR run with first ${EVENT_LIMIT} events"
echo "================================================="
