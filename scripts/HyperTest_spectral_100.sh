#!/bin/bash -l
#SBATCH --job-name=HyperTest_Spectral_truth_100
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
PE_OUTDIR="${RUNDIR}/outdir_truth_delta_spectral_SEOBNR"
...
OUTDIR="${RUNDIR}/outdir_hyperpe_spectral_truth_delta_${EVENT_LIMIT}"
LABEL="spectral_truth_delta_${EVENT_LIMIT}"
...
echo "================================================="
echo "Starting spectral truth-delta run with first ${EVENT_LIMIT} events"
echo "================================================="
