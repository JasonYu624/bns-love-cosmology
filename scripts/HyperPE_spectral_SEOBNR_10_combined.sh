#!/bin/bash -l
#SBATCH --job-name=HyperPE_Spec_10comb
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Combined posteriors: original + append (2 independent PE runs → ~10k samples/event)
...
OUTDIR="${RUNDIR}/outputs/outdir_spectral_siren_seobnr_10_combined"
LABEL="spectral_siren_seobnr_10_combined"
...
echo "================================================="
echo "Starting spectral-siren SEOBNR combined run with first ${EVENT_LIMIT} events"
echo "================================================="
